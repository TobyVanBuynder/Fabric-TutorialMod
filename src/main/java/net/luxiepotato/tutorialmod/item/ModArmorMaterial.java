...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    ModArmorMaterial(String name, int durabilityMultiplier, int[] protections, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
